...
if __name__ == '__main__':
    ...
    ## Celeb-DF-v3
        ...
        FaceSwap = [os.path.join(os.path.join('Celeb-synthesis', 'FaceSwap'), method) for method in manipulation1]
        FaceReenact = [os.path.join(os.path.join('Celeb-synthesis', 'FaceReenact'), method) for method in manipulation2]
        TalkingFace = [os.path.join(os.path.join('Celeb-synthesis', 'TalkingFace'), method) for method in manipulation3]
        sub_dataset_names = ['Celeb-real', 'YouTube-real'] + FaceSwap + FaceReenact + TalkingFace
        # sub_dataset_names = TalkingFace
        sub_dataset_paths = [Path(os.path.join(dataset_path, name)) for name in sub_dataset_names]
